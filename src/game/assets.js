...
export const ASSETS = {
  sprites: {
    ...
    backgroundLevel4: publicAsset('assets/sprites/background-level-4.png'),
    backgroundLevel5: publicAsset('assets/sprites/background-level-5.png'),
  },
  music: {
    ...
    level4: publicAsset('assets/music/level-4.mp3'),
    level5: publicAsset('assets/music/level-5.mp3'),
